...
st.image(image, caption='O GPT-2 é uma rede neural desenvolvida pela OpenAI capaz de gerar textos, que parecem escritos por humanos, a partir de 8 milhões de documentos em 40 GB. Existem várias versões do GPT-2, sendo que esta aqui gera textos preferencialmente em português. ', use_column_width=True)
